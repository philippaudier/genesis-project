...
## F-1 — Founder's intuition (deposited 2026-07-28, before any S1-002 design; scored apart)

Verbatim:

> Je soupçonne que H-S1-1 est incomplète. Pas fausse. Incomplète.
>
> Parce que si le seuil local suffit à tout expliquer… alors la structure du graphe cesse
> presque d'avoir un rôle. Or toute l'histoire de CT-003 dit exactement l'inverse.
>
> Je soupçonne donc que **activation locale** et **structure globale** vont former une
> interaction. Et cette interaction pourrait devenir la vraie naissance de Science-001.

## Founder's framing of record (same date)

S1-001 asked: *does the world flow?* S1-002 asks: **when does it begin to flow?** The campaign
