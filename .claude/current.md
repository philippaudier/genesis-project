...
- **Next after green:** commit Genesis-010 → **Genesis-011, the first phenomenon** — behaviour that could not exist without relations (Phase 1 of the reconciled roadmap begins).
